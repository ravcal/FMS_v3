...
export function AddMaintenanceForm() {
  ...
  const [isEstimatedCompletionDateOpen, setIsEstimatedCompletionDateOpen] = useState(false);
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Popover open={isScheduledDateOpen} onOpenChange={setIsScheduledDateOpen}>
              ...
              <div className="space-y-2">
                ...
                <Popover open={isEstimatedCompletionDateOpen} onOpenChange={setIsEstimatedCompletionDateOpen}>
                  <PopoverTrigger asChild>
                    <Button variant="outline" className="w-full justify-start text-left font-normal">
                      <CalendarIcon className="mr-2 h-4 w-4" />
                  ...
                  <PopoverContent className="w-auto p-0">
                    <Calendar
                      ...
                      onSelect={(date) => {
                        ...
                        setIsEstimatedCompletionDateOpen(false);
                      }}
                      initialFocus
                    />
                  </PopoverContent>
